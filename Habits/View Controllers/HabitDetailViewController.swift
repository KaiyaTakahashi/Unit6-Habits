...
class HabitDetailViewController: UIViewController {
    ...
    typealias DataSourceType = UICollectionViewDiffableDataSource<ViewModel.Seciton, ViewModel.Item>
    
    enum ViewModel {
        enum Seciton: Hashable {
        ...
        return DataSourceType(collectionView: collectionView)
           ...
           UICollectionViewCell? in
            let cell =
               ...
               "UserCount", for: indexPath) as! UICollectionViewListCell
